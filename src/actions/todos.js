...
export const fetchTodosAPI = () =>
    fetch(`${__API_DOMAIN__}/tasks`) // eslint-disable-line no-undef
    .then(res => res.json())
...
export const addTodoAPI = req =>
    fetch(`${__API_DOMAIN__}/tasks`, fetchOpts('POST', req)) // eslint-disable-line no-undef
...
export const toggleTodoAPI = req =>
    fetch(`${__API_DOMAIN__}/tasks/${req.id}`, fetchOpts('PUT', req)) // eslint-disable-line no-undef
...
export const clearAllAPI = todo =>
    fetch(`${__API_DOMAIN__}/tasks/${todo.id}`, fetchOpts('DELETE')) // eslint-disable-line no-undef
